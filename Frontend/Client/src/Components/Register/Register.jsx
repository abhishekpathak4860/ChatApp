...
//   return (
//     <div
//       className="flex flex-col items-center justify-center  bg-green-100 p-8"
//       style={{
//         background:
//           "linear-gradient(45deg, #262140 25%, #2621400d), linear-gradient(to bottom, #2621400d, #262140b3)",
//       }}
//     >
//       <div className="flex flex-col max-w-[350px]  w-full md:max-w-[450px] mx-auto bg-white p-6 rounded-md shadow-lg">
